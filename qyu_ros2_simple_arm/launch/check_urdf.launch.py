...
def generate_launch_description():
    ...
    pkg_qyu_ros2_simple_arm = FindPackageShare('qyu_ros2_simple_arm')
    default_rviz_config_path = PathJoinSubstitution([pkg_qyu_ros2_simple_arm, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the qyu_ros2_simple_arm package
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'qyu_ros2_simple_arm',
