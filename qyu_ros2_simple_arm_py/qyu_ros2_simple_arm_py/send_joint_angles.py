...
class JointAnglePublisher(Node):
    def __init__(self):
        ...
        joint_names = ['shoulder_pan_joint', 'shoulder_lift_joint', 'elbow_joint', 'wrist_joint', 'virtual_roll_joint', 'virtual_yaw_joint']
        ...
        point.positions = [0.0, 0.91, 1.37, -0.63, 0.0, 0.0]
